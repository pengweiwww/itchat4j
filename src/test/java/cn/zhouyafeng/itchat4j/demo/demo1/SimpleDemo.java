...
public class SimpleDemo implements IMsgHandlerFace {
	...
	public String picMsgHandle(BaseMsg msg) {
		...
		String picPath = MyTest.ROOT_PATH+"/pic" + File.separator + fileName + ".jpg"; // 调用此方法来保存图片
	...
	public String voiceMsgHandle(BaseMsg msg) {
		...
		String voicePath = MyTest.ROOT_PATH+"/voice" + File.separator + fileName + ".mp3";
		new File(voicePath).getParentFile().mkdirs();
	...
	public String viedoMsgHandle(BaseMsg msg) {
		String fileName = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());
		String viedoPath = MyTest.ROOT_PATH+"/viedo" + File.separator + fileName + ".mp4";
		new File(viedoPath).getParentFile().mkdirs();
	...
	public String mediaMsgHandle(BaseMsg msg) {
		...
		String filePath = MyTest.ROOT_PATH+"/file" + File.separator + fileName; // 这里是需要保存收到的文件路径，文件可以是任何格式如PDF，WORD，EXCEL等。
